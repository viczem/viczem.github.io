      ...
      <body>
        <main class="wrap">
          ...
          <div class="notice">
            ...
            <div>
              <strong>Это веб-лента</strong>, также известная как RSS-лента.
              <p>
                Подпишитесь, скопировав URL из адресной строки в программу
                для чтения RSS, или посетите
                <a>
          ...
          <p class="meta">
            ...
            <xsl:choose>
              <xsl:when test="count(/rss/channel/item) = 1"> публикация</xsl:when>
              <xsl:otherwise> публикаций</xsl:otherwise>
            </xsl:choose>
            ·
            <a>
              <xsl:attribute name="href"><xsl:value-of select="/rss/channel/link" /></xsl:attribute>
          ...
          <footer>
            Сгенерировано с помощью <a href="https://docs.astro.build/en/recipes/rss/">@astrojs/rss</a>.
            Стили находятся в <code>/rss/styles.xsl</code>.
          </footer>
        </main>
      </body>
    </html>
